...
#| echo: false 
#| message: false
#| label: fig-familysizedistribution
#| fig-cap: Number of 2, 3, and 4-person Census Families Across Toronto Neighbourhoods
...
family_size$`Neighbourhood Number` = as.numeric(as.character(family_size$`Neighbourhood Number`))
family_size$`2 persons` = as.numeric(as.character(family_size$`2 persons`))
family_size$`3 persons` = as.numeric(as.character(family_size$`3 persons`))
family_size$`4 persons` = as.numeric(as.character(family_size$`4 persons`))

ggplot(family_size, aes(x = "Neighbourhood Name", y = "2 persons")) + 
